...
const init = () => {
  ...
  let option: any;
  // var uploadedDataURL = "https://geo.datav.aliyun.com/areas_v3/bound/360000_full.json";
  ...
  //获取青岛地图数据。
  $.get('https://geo.datav.aliyun.com/areas_v3/bound/360000_full.json', function (getJSON) {
    echarts.registerMap('江西', getJSON);
    option = {
      series: [
        {
          tooltip: {
